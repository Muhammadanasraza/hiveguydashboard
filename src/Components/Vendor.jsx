               ...
               <div class="card">
                    <div class="card-body">
                         ...
                         <div class="progress progress-soft progress-md">
                              <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" role="progressbar"   aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                         </div>
                    ...
                    <div class="card-footer border-top gap-1 hstack">
                         ...
                         <a href="#!" class="btn btn-light w-100">Edit </a>
